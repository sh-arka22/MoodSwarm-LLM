"""SFT/DPO fine-tuning entry point — runs on SageMaker GPU instance.

Uses Unsloth for memory-efficient QLoRA fine-tuning of Llama 3.1 8B.
Supports two modes:
  - SFT: Supervised fine-tuning with instruction-answer pairs (Alpaca format)
  - DPO: Direct preference optimization with chosen/rejected pairs

This script is NOT imported locally — it runs as SageMaker entry_point.
"""
...
def _patch_dynamic_cache() -> None:
    """Unsloth 2024.9 injects cache_implementation='dynamic' into every generate() call,
...
if __name__ == "__main__":
    ...
    print(f"Datasets will be loaded from HF workspace: '{args.dataset_huggingface_workspace}'")  # noqa
    print(f"Models will be saved to HF workspace: '{args.model_output_huggingface_workspace}'")  # noqa

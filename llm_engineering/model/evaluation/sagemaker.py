"""SageMaker launcher for evaluation jobs.

Submits evaluate.py as a SageMaker processing job with vLLM for batch inference
and GPT-4o-mini for LLM-as-judge scoring.
"""

"""Dataset generators — instruction (SFT) and preference (DPO) dataset generation via LLM.

Each generator:
  1. Takes cleaned documents from the feature store
  2. Chunks them into 1000-2000 char extracts
  3. Creates prompts asking an LLM to generate training samples
  4. Batches LLM calls (24 at a time) and parses JSON output
  5. Post-processes and splits into train/test
"""

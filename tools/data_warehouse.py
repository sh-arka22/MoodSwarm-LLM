...
@click.option(
    ...
    is_flag=True,
    default=False,
    help="Export your data warehouse to JSON files.",
)
@click.option(
    "--import-raw-data",
    is_flag=True,
    default=False,
    help="Import JSON files into your data warehouse.",
)
@click.option(
    "--data-dir",
...
def main(
    ...
    assert export_raw_data or import_raw_data, "Specify at least one operation: --export-raw-data or --import-raw-data"
